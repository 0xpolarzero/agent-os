 ...
 */
export function unwrapType(schema) {
 ...
 */
function getArrayItemTypeName(schema) {
    const def = schema._def;
    const typeName = def.typeName ?? "";
    if (typeName === "ZodOptional" || typeName === "ZodDefault") {
 ...
 */
export function getFieldInfos(schema) {
    const def = schema._def;
 ...
 */
export function getZodDescription(schema) {
    const def = schema._def;
 ...
 */
export function getZodEnumValues(schema) {
    const def = schema._def;
    const typeName = def.typeName ?? "";
    if (typeName === "ZodOptional" || typeName === "ZodDefault") {
