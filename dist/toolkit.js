    ...
    return {
        ...
        tools: {
            "run-command": hostTool({
                description: "Run a command synchronously in the sandbox and return its stdout, stderr, and exit code.",
            ...
            "create-process": hostTool({
                description: "Start a long-running background process in the sandbox. Returns a process ID for later management.",
                inputSchema: z.object({
